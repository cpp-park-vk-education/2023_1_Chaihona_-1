...
private:
  ...
  virtual std::string GetMatchTableResponse(std::vector<std::pair<Form, std::vector<Contact>>>) = 0;
...
private:
  ...
  virtual std::string GetMatchTableResponse(std::vector<std::pair<Form, std::vector<Contact>>>) override;
